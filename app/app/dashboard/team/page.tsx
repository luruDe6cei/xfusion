  ...
  return (
    <DashShell>
      ...
      <div className="rounded-[var(--radius-8)] border border-solid border-[var(--color-grey-2)] bg-[var(--color-grey-white)] overflow-hidden">
        <div className="grid grid-cols-[56px_1fr_1fr_1fr] gap-[var(--spacing-16)] items-center px-[var(--spacing-24)] py-[var(--spacing-16)] border-b border-solid border-[var(--color-grey-2)] text-[length:var(--font-size-14)] text-[var(--color-grey-5)]">
        ...
        <div className="grid grid-cols-[56px_1fr_1fr_1fr] gap-[var(--spacing-16)] items-center px-[var(--spacing-24)] py-[var(--spacing-16)]">
          ...
          <span>Alon Erza</span>
          <span className="text-[var(--color-grey-5)]">CEO · Owner</span>
          <span className="text-[var(--color-grey-5)]">ehavreliuc@cloudcompanion.io</span>
        </div>
      </div>
    </DashShell>
  );
